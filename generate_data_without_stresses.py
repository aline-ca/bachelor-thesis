...
#####################################################################
# File:                           generate_data_without_stresses.py #
...
#   words (WITHOUT stress of unknown words). It will also filter    #
...
output_file         = 'data/training_data_without_stresses.txt'                 # Write new data into this file
...
def get_phonemes_for_line(words):
    ...
    for word in words:
        ...
        # CASE 2: Look up word in unknown word dict
            ...
            phonemes_for_line.append(pronouncing_list[0].strip('\n'))
