    ...
    with open(filename, "r") as file:
        ...
        for row in tsv_reader:
            ...
            if row[0] != "<poem>" and row[0] != "</poem>" and row[0] != "<line>" and row[0] != "</line>":
                ...
                word_repr = row[1]
                # Hand-crafted rules to replace phonemes that get generated by G2P:
...
poems, phonemes = read_in_data("../g2p_processing/g2p_tool_output/2000_different_rand_poems_3_g2p.txt")
#poems, phonemes = read_in_data("../g2p_processing/g2p_tool_output/rhyme_score_testing.txt")
#poems, phonemes = read_in_data("../g2p_processing/g2p_tool_output/g2p_output.txt")
